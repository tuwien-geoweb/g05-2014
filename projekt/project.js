...
var CarSharing = new ol.layer.Vector({
  source: new ol.source.GeoJSON({
    ...
    style: new ol.style.Style({
       image: new ol.style.Icon({src: 'http://student.ifip.tuwien.ac.at/geoweb/2014/g05/page/img/carsharingogd.png', scale: 0.5 })
    })
});
...
var Haltestellen = new ol.layer.Vector({
  source: new ol.source.GeoJSON({
    ...
    style: new ol.style.Style({
       image: new ol.style.Icon({src: 'http://student.ifip.tuwien.ac.at/geoweb/2014/g05/page/img/haltestellewlogd.png', scale: 0.5})
    })
});
...
var Maerkte = new ol.layer.Vector({
  source: new ol.source.GeoJSON({
    ...
    style: new ol.style.Style({
       image: new ol.style.Icon({src: 'http://student.ifip.tuwien.ac.at/geoweb/2014/g05/page/img/marktogd.png', scale: 0.5})
    })
});
